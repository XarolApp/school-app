      ...
      <div className="settings-layout">
        ...
        <section className="panel panel-lg settings-section">
          <div className="settings-section-head">
            ...
            <p className="settings-section-text">
              Nastavení platí pro tohle zařízení a zůstane i po odhlášení.
            </p>
          </div>

          {/* Same sliding pill as the auth tabs: the highlight travels to the
              option you picked instead of blinking out of one cell and into
              another. The index drives a translate in CSS — see .tab-thumb. */}
          <div
            className="segmented"
            role="radiogroup"
