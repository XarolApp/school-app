    ...
    <div className="page page-auth">
      <div className="auth-layout">
        <div className="page-header">
          <p className="eyebrow">7 dní zdarma</p>
          <h1>Vytvořit účet</h1>
          <p className="lede">
            Vyzkoušej celou databázi škol na týden zdarma. Platit začneš až
            potom — a jen když budeš chtít pokračovat.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="panel panel-lg auth-form">
          ...
          >
            ...
            {submitting ? 'Vytvářím účet…' : 'Začít 7 dní zdarma'}
          </button>
        </form>
      </div>
    </div>
