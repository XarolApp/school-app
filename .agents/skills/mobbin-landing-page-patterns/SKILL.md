...
description: Real-shipped-product patterns for pre-signup marketing/landing pages, sourced from a 73-search Mobbin survey (~130 products, all web). Use when designing or reviewing a hero, landing page, or pre-signup marketing surface — most useful for Codex Design. Not ŠkolaMatch-specific; broad reference material.
---
